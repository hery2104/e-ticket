	...
	<div class="box-header with-border">
		<div class="row">
			<div class="col-md-4">
				...
				<a class="btn-sm btn btn-primary" id="ajaxlink" href="index.php?pages=addtiket"><i class="fa fa-plus"></i></a>
			...
			success : function(response){
				...
				if (response.length==4) {
					...
					$.each(result, function(index, el){
						...
						tbodyHtml += '<td>'+el.tgl_keberangkatan+'</td>'
						tbodyHtml += '<td>'+aktif+'</td>'

						tbodyHtml += '<td>'
						tbodyHtml += '<button class="btn-sm btn btn-danger btn-sm" data-url="action.php?q=deletetiket&id='+el.id+'" data-id="'+el.id+'" data-page="'+page+'" id="hapusData"><i class="fa fa-trash"></i></button>'
