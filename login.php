<?php
// echo $newpass=password_hash('szydev', PASSWORD_DEFAULT);
...
<img id="profile-img" class="profile-img-card" src="assets/img/favicon.png" />
            <p id="profile-name" class="profile-name-card">Suzuya Hotel</p>
<form class="form-signin" method="POST">
  <div class="row" style="margin-top: 400px !important;">
    <center>
    <?php 
    if (isset($error)) { ?>
